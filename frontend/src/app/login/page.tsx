...
function LoginForm() {
  ...
  // Initialize Google Identity Services (GIS) on load
  ...
  const handleGoogleSignIn = async () => {
    ...
    // 1. If Google Identity Services is initialized with a client ID, trigger native popup directly
        ...
        >
          ...
          <div className="p-8 rounded-2xl bg-[#141517] border border-[#232529] space-y-5 shadow-xl">
            ...
            <div className="space-y-2.5">
              {/* Native Google Identity Services Popup Button Container */}
              {googleClientId && (
                <div 
                  ref={googleButtonContainerRef} 
                  className={`w-full flex justify-center overflow-hidden rounded-xl ${googleGsiReady ? "block" : "hidden"}`} 
                />
              )}

              {/* Styled Fallback Google Button */}
              {(!googleClientId || !googleGsiReady) && (
                <button
                  type="button"
