...
function LoginForm() {
  ...
  // Initialize official Google Identity Services in English (hl=en)
      ...
      try {
        ...
        if (googleButtonContainerRef.current) {
          ...
          window.google.accounts.id.renderButton(googleButtonContainerRef.current, {
            ...
            shape: "rectangular",
            logo_alignment: "left",
            width: googleButtonContainerRef.current.offsetWidth || 384,
            locale: "en",
          });
        }
  ...
  // Native In-Page Google Sign-In Trigger (No Supabase Domain Redirect)
          ...
          <div className="p-8 rounded-2xl bg-[#141517] border border-[#232529] space-y-5 shadow-xl">
            ...
            <div className="space-y-2.5">
              ...
              <div 
                ...
                className={`w-full flex justify-center overflow-hidden rounded-xl min-h-[40px] ${googleGsiReady ? "block" : "hidden"}`} 
              />

              {/* Styled Direct Google Fallback Button */}
              {!googleGsiReady && (
                <button
                  type="button"
