...
function LoginForm() {
  ...
  // Initialize Google Identity Services (GIS) with English locale (hl=en)
  ...
  const handleGoogleSignIn = async () => {
    ...
    // 1. If Google Identity Services is initialized with client ID, trigger native in-page popup
    ...
    // 2. Direct Supabase Google OAuth Provider Fallback
    await fallbackOAuthGoogle();
  };

  const fallbackOAuthGoogle = async () => {
    try {
  ...
  return (
    <>
      {/* Load Google Identity Services script forced to English (hl=en) */}
      <Script 
      ...
      <div className="min-h-screen bg-[#0c0d0e] flex flex-col justify-center items-center px-6 py-12 text-[#f0f2f5]">
        ...
        >
          ...
          <div className="p-8 rounded-2xl bg-[#141517] border border-[#232529] space-y-5 shadow-xl">
            ...
            {/* Single Sign-On (OAuth) Buttons - Pixel-Perfect Matching */}
